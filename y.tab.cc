...
{
       0,   172,   172,   176,   177,   181,   185,   188,   192,   198,
     199,   203,   224,   232,   235,   239,   240,   244,   251,   259,
     269,   277,   284,   294,   298
};
#endif
...
static const char *const yytname[] =
{
  ...
  "AMPERSAND", "GREATAMPERSAND", "GREATGREAT", "LESS", "PIPE",
  "GREATGREATAMPERSAND", "TWOGREAT", "$accept", "goal", "command_list",
  "command_line", "command_and_args", "argument_list", "argument",
  "command_word", "pipe_list", "iomodifier_list", "iomodifier_opt",
...
{
       4,     0,     0,     1,     0,    12,     6,     3,    14,    10,
      16,     7,     8,     0,    24,    11,     9,    13,     0,    23,
       0,     0,     0,     0,     0,    15,     0,    17,    20,    18,
      21,    19,    22,     5
};
...
{
      18,     3,    19,    20,    21,    22,    11,    23,    24,    -2,
       4,    15,     5,    13,     5,     6,    27,    28,    29,    30,
      31,    32,     0,    17,     0,    33
};
...
{
       0,    15,    16,     0,     1,     3,     6,    17,    18,    21,
      22,     6,    19,    11,    23,     3,    20,    18,     5,     7,
       8,     9,    10,    12,    13,    24,    25,     3,     3,     3,
       3,     3,     3,     6
};
...
#line 203 "shell.y" /* yacc.c:1646  */
    ...
    if (*((yyvsp[0].cpp_string)) != "${?}") {
      expandWildcardsIfNecessary((yyvsp[0].cpp_string), "", 0);
      if (matches.size() == 0) {
